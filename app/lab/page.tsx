...
export default function HomeLab() {
  ...
  // Self-hosted services running on the lab
  const services = [
    {
      name: "SplitEase",
      ...
      status: "Operational",
      description:
        "Room-based expense splitting platform BETTER THAN SPLITWISE. Self-hosted with automatic CI/CD deployments.",
    ...
    <div className="min-h-screen bg-black text-white font-sans noise">
        ...
        <div className="border-beam-container bg-black/40 backdrop-blur-xl rounded-full border border-white/10">
          ...
          <div className="px-6 py-3 relative z-10">
            <div className="flex justify-between items-center">
              <Link
                href="/"
                className="text-sm font-heading font-semibold tracking-tight hover:text-gray-300 transition-colors flex items-center gap-2"
              >
                <ArrowLeft size={16} />
        ...
        {isMobileMenuOpen && (
          <div className="absolute top-full left-0 w-full mt-2 p-4 glass-dark rounded-3xl border border-white/10 flex flex-col gap-4 md:hidden animate-in fade-in slide-in-from-top-5">
            <nav className="flex flex-col gap-4 text-sm font-mono text-gray-400">
              ...
              <Link
                href="/lab"
                className="text-white font-bold transition-colors p-2"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                LAB
              </Link>
      ...
      <div className="fixed top-6 right-6 z-50 hidden md:flex items-center gap-3">
        <div className="flex flex-col items-end">
          <span className="hidden md:block text-[10px] text-gray-400 font-mono uppercase tracking-widest">
            Local Time
          </span>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mb-20">
            ...
            <p className="text-gray-400 text-lg md:text-xl max-w-2xl font-light leading-relaxed">
              Exploring infrastructure, virtualization, and network security
              through a personal testing environment. My home lab serves as a
              playground for self-hosting services and learning modern DevOps
              practices.
            </p>
          </div>
                ...
                <div className="space-y-4 pt-4 border-t border-white/5">
                  <div className="flex flex-wrap gap-2">
                    {service.tech.map((t, i) => (
                      <span
                        key={i}
                        className="text-[10px] px-2 py-1 bg-white/5 text-gray-500 rounded font-mono uppercase"
                      >
                        {t}
                      </span>
                    ))}
              ...
              <div className="flex items-center justify-center relative">
                ...
                <div className="relative w-full aspect-square max-w-md overflow-hidden px-4 py-4 z-10 flex items-center justify-center">
                  ...
                  <div className="relative z-10">
                    <div className="w-48 h-48 bg-black/40 backdrop-blur-3xl rounded-[3rem] border border-white/10 flex items-center justify-center group hover:scale-105 transition-transform duration-500 relative overflow-hidden">
                      ...
                      <Server
                        size={80}
                        className="text-blue-500 group-hover:text-white transition-colors duration-500 relative z-10"
                      />
                    ...
                    <div className="absolute -bottom-8 -right-8 flex flex-col items-end animate-fade-in delay-1000">
                      ...
                      <span className="hud-value text-green-400">
                        OPERATIONAL
                      </span>
                    </div>
                  </div>
          ...
          <section className="py-16 md:py-32 border-t border-white/5 relative z-10">
            <div className="glass-dark rounded-[2rem] md:rounded-[3rem] p-8 md:p-20 text-center border border-white/10 relative overflow-hidden group">
              ...
              <h2 className="text-3xl md:text-6xl font-heading font-bold mb-6 md:mb-8 transition-transform group-hover:scale-[1.02] duration-500">
                ...
                <span className="text-white/40 italic">meaningful</span>
              </h2>
